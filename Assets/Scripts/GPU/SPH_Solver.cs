...
public class SPH_Solver : MonoBehaviour
{
    ...
    public Mesh particleMesh; // particle mesh
    public float particleRenderSize = 1f;
    public Material material; // particle material

    public float mass = 4f;
    public float gasConstant = 1500;
    public float restDensity = 9f;

    public float viscosityCoefficient = 2.5f;
    public float[] gravity = { 0.0f, -9.81f* 2000f, 0.0f }; // maybe passed via vector3
